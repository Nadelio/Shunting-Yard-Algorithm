    ...
    public static <T, R> void evaulateCases(T[] cases, R[] expectedResults, Function<T, R> operation) {
        for(int i = 0; i < cases.length; i++) {
            ...
            try {
                ...
                assert (result.equals(expectedResult)) : Colors.ERROR + "Test case failed. Expected: " + Colors.INFO + expectedResult + Colors.ERROR + ", but got: " + Colors.INFO + result + Colors.RESET;
